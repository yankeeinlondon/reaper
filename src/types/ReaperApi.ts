...
import type { FileDiagnostic, FileMeta } from "./file-types";
import type { SourceFilePath, SymbolScope } from "./general";
import type { PackageJson } from "./package";
import type { FunctionRef, ReExportRef, TypeUtilityRef, VariableRef } from "./reference-types";
import type { AstKind, SymbolMeta } from "./SymbolMeta";
...
export interface ReaperApi__Runtime__None<T extends readonly Feature[]> {
    /**
...
export interface ReaperApi__Runtime__Ready<_T extends readonly Feature[]> {
    runtime: {
...
export interface ReaperApi__Types__None<T extends readonly Feature[]> {
    /**
     * Finds all the runtime's Symbols and provides an API
     * surface for it under the `runtime` property.
     */
...
export interface ReaperApi__Types__Loaded<
...
export interface ReaperApi__SourceFiles__Meta<_T extends readonly Feature[]> {
    fileImports: any;
...
export interface ReaperApi__SourceFiles<_T extends readonly Feature[]> {
    /**
...
export interface ReaperApi__Diagnostics__None<T extends readonly Feature[]> {
    /**
...
export interface ReaperApi__Diagnostics__Loaded<T extends readonly Feature[]> {
